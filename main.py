...
def plot_transactions(df):
    ...
    plt.plot(monthly.index, monthly.get("Income", 0),
             marker="o", linewidth=3, label="Income")

    plt.plot(monthly.index, monthly.get("Expense", 0),
             marker="o", linewidth=3, label="Expense")
...
def main():
    while True:
        ...
        if choice == "1":
            ...
            if not df.empty and input("Do you want to see a monthly plot? (y/n): ").lower() == "y":
